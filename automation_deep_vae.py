...
#get_ipython().system('gdown --id 1WRVJXWU82ZiNZTFLJ3kdh2A9E-gruHmd -O processed.zip')


# In[10]:


#get_ipython().system('unzip processed -d processed')
...
config = {
    ...
    'DROPOUT': 0.1,
    'EARLYSTOP': 10, # Number of epoches
