...
Original file is located at
    https://colab.research.google.com/drive/125Sbe4QY4OQjFgyhfw22LL6B9YQVDEE8
"""
...
with open(os.path.join(DIR, "model_config.json"), "w") as json_file:
    ...
    config['PYTHON_FILE'] = 'automation_v3'
...
def build_model(n_meta, n_raw):
    ...
    final_output = Conv1DTranspose(
            filters=32, kernel_size=3, padding="same", activation="relu", strides=2
    )(final_output)
    final_output = Conv1DTranspose(
